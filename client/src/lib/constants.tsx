...
export const skills: Skill[] = [
  ...
  { name: 'Tailwind CSS', level: 92, icon: 'TailwindCss', category: 'frontend' },
...
export const services: Service[] = [
  {
    ...
    description: 'Full-stack web applications built with modern technologies like React, Node.js, and TypeScript. Perfect for businesses needing custom solutions.',
    icon: 'Globe',
    features: [
  ...
  },
  {
    ...
    description: 'Complete e-commerce solutions with payment processing, inventory management, and admin dashboards built for scalability.',
    icon: 'ShoppingCart',
    features: [
  ...
  },
  {
    ...
    description: 'Software-as-a-Service platforms with subscription management, multi-tenancy, and scalable architecture.',
    icon: 'Cloud',
    features: [
  ...
  },
  {
    ...
    description: 'RESTful APIs and microservices with comprehensive documentation, authentication, and third-party integrations.',
    icon: 'Link',
    features: [
      'RESTful API Design',
      'API Documentation',
...
export const projects: Project[] = [
  {
    ...
    description: 'Revolutionary voting system integrating biometric authentication with secure data management. Successfully piloted in 2016 with 99.8% accuracy rate.',
    image: 'https://images.unsplash.com/photo-1586671267731-da2cf3ceeb80?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=400',
    technologies: ['Embedded Systems', 'Biometric APIs', 'Secure Database', 'Real-time Processing'],
    featured: true,
    metrics: [
      { label: 'Accuracy Rate', value: '99.8%' },
      { label: 'Processing Time', value: '<3 seconds' },
      { label: 'Pilot Scale', value: '5,000+ users' }
    ]
  },
  {
    id: 'ecommerce-platform',
    title: 'Multi-vendor E-commerce Platform',
    description: 'Comprehensive e-commerce solution supporting multiple vendors, real-time inventory, and integrated payment processing.',
  ...
  },
  {
    ...
    description: 'Real-time analytics platform with customizable dashboards, automated reporting, and multi-tenant architecture.',
  ...
  },
  {
    ...
    description: 'Secure API platform for financial transactions with real-time fraud detection and compliance monitoring.',
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Improved team productivity by 30% through code standardization',
  ...
  },
  {
    ...
    period: '2017 - 2018',
    description: 'Started career developing websites and learning modern web development practices.',
